...
| 7 | Différenciation 49/1 (crypto) | Fermée | Primitive de production : signature aveugle RSABSSA RFC 9474 (vera_signature_manager.py, standard audite). La LOGIQUE de partition (nominal, double-depense, 49/1 bloquee, rejeu cross-epoque) est validee 9/9 sur un prototype (archive/test_porte7.py) ; ce prototype n est PAS la primitive de production. Test dedie de la primitive de prod sur base jetable : a ajouter. |
