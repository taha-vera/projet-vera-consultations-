...
>         let amount_u = (amount * MICRO as f64) as u64;>         if amount_u == 0 {
...
>         ) {
>             let mut b = EpsilonBudgetExact::new(10.0);>             let mut prev = 0u64;
...
> }
> EOF
~/ancre-v03 $ cargo test empirical 2>&1 | tail -5
test empirical_dp_tests::empirical_05_dp_large_delta ... ok
test empirical_dp_tests::empirical_05_dp_small_delta ... ok

test result: ok. 2 passed; 0 failed; 0 ignored; 0 measured; 28 filtered out; finished in 0.15s
...
~/ancre-v03 $ git commit -m "ANCRE v0.5 — Q10 entiers, Q13 proptest, Q14 empirique DP — 30/30"
[main 9165db7] ANCRE v0.5 — Q10 entiers, Q13 proptest, Q14 empirique DP — 30/30
...
> }
> EOF
~/ancre-v03 $ grep hmac Cargo.toml
~/ancre-v03 $ cat >> Cargo.toml << 'EOF'
> hmac = "0.12"
> EOF
~/ancre-v03 $
~/ancre-v03 $ cargo build 2>&1 | tail -3

For more information about this error, try `rustc --explain E0432`.
error: could not compile `ancre-v03` (bin "ancre") due to 1 previous error
~/ancre-v03 $ cargo build 2>&1 | grep "error\[E"
error[E0432]: unresolved import `hmac`
~/ancre-v03 $ cat Cargo.toml
[package]
name = "ancre-v03"
version = "0.3.0"
edition = "2021"
...
proptest = "1.0"
hmac = "0.12"
~/ancre-v03 $ sed -i 's/\[dev-dependencies\]/[dependencies]\nhmac = "0.12"\n\n[dev-dependencies]/' Cargo.toml
~/ancre-v03 $ sed -i '/^hmac = "0.12"$/d' Cargo.toml
~/ancre-v03 $ cargo build 2>&1 | tail -3
   |
16 | [dependencies]
   |  ^^^^^^^^^^^^
...
~/ancre-v03 $ cargo build 2>&1 | tail -3
   ...
   Compiling ancre-v03 v0.3.0 (/data/data/com.termux/files/home/ancre-v03)
    Finished `dev` profile [unoptimized + debuginfo] target(s) in 6.05s
~/ancre-v03 $ cargo test 2>&1 | tail -3

test result: ok. 30 passed; 0 failed; 0 ignored; 0 measured; 0 filtered out; finished in 0.50s

~/ancre-v03 $ git add src/main.rs Cargo.toml
~/ancre-v03 $ git commit -m "ANCRE v0.5 — HMAC AuditChain, Q10/Q13/Q14, 30/30 tests"
[main 4a83373] ANCRE v0.5 — HMAC AuditChain, Q10/Q13/Q14, 30/30 tests
 2 files changed, 41 insertions(+)
~/ancre-v03 $ cat ~/ancre-v03/src/main.rs
use rand::rngs::OsRng;
use rand::Rng;
